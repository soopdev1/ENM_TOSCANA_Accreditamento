...
import static rc.soop.action.Pdf_new.allegatoC_mod1;
import static rc.soop.action.Pdf_new.allegatoC_mod2;
                ...
                case "DONLC": {
                    switch (tiposoggetto) {
                        case "soggettosingolo": {
                            downloadFile = new File(pathtemp + File.separator + tipodoc + "_" + Utility.generaId(50) + extdocx);
